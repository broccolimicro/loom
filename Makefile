...
OBJS	= src/data/canonical.o src/data/minterm.o src/data/path_space.o src/data/path.o src/data/petri.o src/data/program_counter.cpp src/data/variable_space.o src/data/variable.o \
