...
nfet = nmos("svt", "sky130_fd_pr__nfet_01v8", [df, ns, pw], [hv, lv])
nfet_lvt = nmos("lvt", "sky130_fd_pr__nfet_01v8_lvt", [df, ns, lv, pw])

pfet = pmos("svt", "sky130_fd_pr__pfet_01v8", [df, ps, nw], [hv, lv])
pfet_hvt = pmos("hvt", "sky130_fd_pr__pfet_01v8_hvt", [df, ps, hv, nw])
pfet_lvt = pmos("lvt", "sky130_fd_pr__pfet_01v8_lvt", [df, ps, lv, nw])
